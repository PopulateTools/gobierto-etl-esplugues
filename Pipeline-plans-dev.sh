...
# Load > Import plans
cd $DEV/gobierto; bin/rails runner $DEV/gobierto-etl-esplugues/importer/run.rb /tmp/esplugues.plan.json esplugues.gobify.net pam-2016-2019 reset_previous_data
